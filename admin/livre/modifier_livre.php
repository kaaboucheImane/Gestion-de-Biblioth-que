  ...
  <script>
    $(document).ready(function(){
     ...
     function check_cote(){
        ...
        if(cote == ''){
            $("#res_cote").html(" entrer votre coté !").css("color","red");
            $("#res_cote").show();
            res_cote=false;
            ...
            $("#res_cote").html("Votre coté n'est pas valide !").css("color","red");
            $("#res_cote").show();
...
if( res_numero !== false && res_auteur !== false  && res_titre !== false && res_edition !== false && res_lieu !== false && res_annee !== false && res_cote !== false && res_nombreDeCopie !== false ){
     swal({
       title: "Êtes-vous sûr de Modifier ce livre?",
       icon: "warning",
       buttons:["No", "Oui"],
     ...
     .then((willDelete) => {
       if (willDelete) {
         swal("Ce livre est bien  modifié", {
           icon: "success",
          
         });

         $("#res_modifier").load("../admin/livre/fonction_modifier_livre.php",{id:id,auteur:auteur,titre:titre,edition:edition,lieu:lieu,annee:annee,cote:cote,matiere:matiere,nombreDeCopie:nombreDeCopie,niveau:niveau,collection:collection,n:n,mois:mois,nb_partie:nb_partie,nb_edition:nb_edition,numero:numero,categorie:categorie,sous_categorie:sous_categorie});


       }else {
         swal("Ce livre n'est pas modifier");
       }
     })
...
<div id="topaginatorlivre">
        ...
        <button id="ici" class="btn btn-default btn-lg">
         ...
         <div class="container login-container">
            <div class="row" id="two_div">
             <form  method="post" id="form_modifier_livre">
                <div class="col-md-6 login1" >
                  
                        <div class="form-group">
                        	<label>Numéro * :</label>
                            <input type="text" class="form-control"  value="<?php echo $_POST['numero']; ?>"  id="numero"  />
                            <span id="res_numero"></span>
                        </div>
                        <div class="form-group">
                        	<label>Auteur * :</label>
                            <input type="text" class="form-control"  value="<?php echo $_POST['auteur']; ?>"  id="auteur"  />
                            <span id="res_auteur"></span>
                        </div>
                        <div class="form-group">
                        	<label>Titre * :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['titre']; ?>" id="titre"  />
                            <span id="res_titre"></span>
                            
                        </div>
                        <div class="form-group">
                        	<label>Édition * :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['edition']; ?>" id="edition"   />
                            <span id="res_edition"></span>
                        </div>
                        <div class="form-group">
                        	<label>Lieu * :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['lieu']; ?>" id="lieu"   />
                            <span id="res_lieu"></span>
                        </div>
                        <div class="form-group">
                        	<label> Année * :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['annee']; ?>" id="annee"  />
                            <span id="res_annee"></span>
                        </div>
                        <div class="form-group">
                        	<label>Coté * :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['cote']; ?>" id="cote"   />
                            <span id="res_cote"></span>
                        </div>
                        <div class="form-group">
                        	<label>Matiére :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['matiere']; ?>" id="matiere" />
                        </div>
                        <div class="form-group">
                        	<label>Nombre de copie * :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['nombreDeCopie']; ?>" id="nombreDeCopie" />
                ...
                <div class="col-md-6 login2">
                       <div class="form-group">
                        	<label>Niveau :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['niveau']; ?>" id="niveau"  />
                        </div>
                        <div class="form-group">
                        	<label>Collection :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['collection']; ?>" id="collection"   />
                        </div>
                        <div class="form-group">
                        	<label>N :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['n']; ?>" id="n"  />
                        </div>
                        <div class="form-group">
                        	<label>Mois :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['mois']; ?>" id="mois"   />
                        </div>
                        <div class="form-group">
                        	<label>Nombre de partie :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['nb_partie']; ?>" id="nb_partie"  />
                        </div>
                        <div class="form-group">
                        	<label>Nombre d'édition :</label>
                            <input type="text" class="form-control" value="<?php echo $_POST['nb_edition']; ?>" id="nb_edition" />
                        </div>
                        <div class="form-group">
                        	...
                        	<?php
                               ...
                               $r=$bdd->query("SELECT * FROM categories WHERE categorie NOT IN ('$cat')"); 
                        	?>
                        ...
                        <div class="form-group">
                        	...
                        	<?php
                        	   $souscat=$_POST['sous_categorie'];
                        	   $idsouscat=$_POST['idsouscate'];
                               $bdd = new PDO('mysql:host=localhost;dbname=ouvrages', 'root', '',array (PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES \'UTF8\''));  
                               $req=$bdd->query("SELECT * FROM sous_categories WHERE id NOT IN ('$idsouscat') "); 
                        	?>
                            <select class="form-control" name="sous_categorie_form" id="sous_categorie_form">
                            	<option value="<?php echo $idsouscat; ?>"><?php echo $cat; ?></option>
                            	<?php 
                        ...
                        <div class="form-group" style="height: 2.7em;">
                            <input type="submit" button  class="btn btn-primary btn-lg" value="Modifier" id="btnModifier" data-id="<?php echo $_POST['id']; ?>"  />
                        </div> 
